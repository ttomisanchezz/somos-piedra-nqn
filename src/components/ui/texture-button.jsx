...
const innerDivVariants = cva("w-full h-full flex items-center justify-center text-muted-foreground", {
  variants: {
    variant: {
      ...
      brand: "gap-2 bg-gradient-to-b from-[#5A6B3F] to-[#4A5832] text-white transition duration-300 ease-in-out hover:from-[#6A7D4A] hover:to-[#5A6B3F] active:from-[#4A5832] active:to-[#3D5235]",
    },
    size: {
      ...
      pill: "text-sm rounded-full px-6 py-3",
    },
  },
  defaultVariants: {
    variant: "primary",
